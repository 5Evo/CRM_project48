...
class CreateForm(forms.ModelForm):
    ...
    phoneNumber = PhoneNumberField(label='ТЕЛЕФОН', required=False, widget=RegionalPhoneNumberWidget(attrs={'placeholder': 'ТЕЛЕФОН', 'class': 'form-control'}))
    secondPhoneNumber = PhoneNumberField(label='ТЕЛЕФОН', required=False, widget=RegionalPhoneNumberWidget(attrs={'placeholder': '+79001112233', 'class': 'form-control'}))
